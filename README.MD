...
- **Robust Authentication**: Powered by Better Auth with support for multiple providers, sessions, and roles (admin/user).
...
- **State Management**: Server state via TanStack Query/ORPC, global client state via Jotai.
